...
/** Model-to-world matrix of the teapot. */
var teapotModelMatrix = mat4.create();
/** Rotation angle of teapot. */
...
function teapotGenerateShape() {
  ...
  /** Indices in obj file starts at 1, so fix it! */
  ...
  for (var i = 0; i < numTriangles; i++) {
    ...
    /** Update the normal of three vertices. */
    for (var v = 0; v < 3; v++) {
 ...
 *
 *  This is extracted from teapot.obj included in the same directory.
 *  Provided on course website: https://courses.engr.illinois.edu/cs418/fa2016/MP/mp3.html
 */
